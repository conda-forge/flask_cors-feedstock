...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask_cors-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8757&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask_cors-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask_cors` can be installed with:

```
conda install flask_cors
```

It is possible to list all of the versions of `flask_cors` available on your platform with:
